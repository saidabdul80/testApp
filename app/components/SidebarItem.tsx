...
const SidebarItem = ({ isOpen, icon: Icon, text, href,active }) => {
    return (
        <Link href={href}>
        <li className={`${active?'bg-gray-600 border-s-4 border-white-200':' border-gray-800  border-s-4 '}   transition-all flex items-center py-2 px-4 text-gray-300  hover:bg-gray-700 hover:text-white relative`}>
